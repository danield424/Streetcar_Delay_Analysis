...
#### Save data ####
streetcar_delay_data <- filter(datastore_resources, name == "ttc-streetcar-delay-data-2024") %>% get_resource()

write_csv(streetcar_delay_data, "data/raw_data/streetcar_delays2024.csv")
